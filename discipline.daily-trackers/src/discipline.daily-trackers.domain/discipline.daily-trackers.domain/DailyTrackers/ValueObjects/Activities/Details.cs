using discipline.daily_trackers.domain.DailyTrackers.BusinessRules.Activities;
using discipline.daily_trackers.domain.SharedKernel;

namespace discipline.daily_trackers.domain.DailyTrackers.ValueObjects.Activities;
